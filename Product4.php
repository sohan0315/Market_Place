...
setcookie('my_array['.$index.']', 'Product4.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product4.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product4.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Drinks / Hot Chocolate<h4>
                  </br>
                  <h6>Hot Chocolate</h6>
