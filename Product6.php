...
setcookie('my_array['.$index.']', 'Product6.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product6.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product6.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Drinks / Caramel Apple Spice<h4>
                  </br>
                  <h6>Caramel Apple Spice</h6>
                  <p>Steamed apple juice complemented with cinnamon syrup, whipped cream and a caramel sauce drizzle.</p>
                </div>
              </div>
