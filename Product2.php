...
setcookie('my_array['.$index.']', 'Product2.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product2.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product2.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Coffees / Blonde Roast<h4>
                  </br>
                  <h6>Blonde Roast</h6>
                  <p>Lightly roasted coffee that's soft, mellow and flavorful. Easy-drinking on its own and delicious with milk, sugar or flavored with vanilla, caramel or hazelnut.</p>
                </div>
              </div>
