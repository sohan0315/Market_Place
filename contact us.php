...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="container-fluid">
        ...
        <div>
            <h1 style='padding: 17px; text-align: center;'>Contacts</h1>
            <div>
                <?php
                     ...
                     while (!feof($fp)){
                      $line = fgets($fp);
                      print "<h6 style='padding: 17px; text-align: center;'> $line </h6>";
                        }
                        //close the file
                        fclose($fp);
                ?>
            <div class="col-md-12">
                <h3 style='padding: 17px; text-align: center;'>Get in touch ! we'd love to hear from you.</h3>
                <br>
