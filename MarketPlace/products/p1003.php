...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($con,"SELECT * FROM product where product_code = 'p1003'");
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 'p1003'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "p1003"';
