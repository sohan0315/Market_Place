...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($con,"SELECT * FROM product where product_code = 'p1007'");
        while($row = mysqli_fetch_assoc($result)){
            echo "<div class='card text-center text-white bg-info mb-3' style='max-width: 50rem;!important'>
                    ...
                    <div class='card-header' style='color:black'>".$row['product_name']."</div>
                    <div class='card-body'>
        ...
        $sql1 = "SELECT * from service_review where product = 'Caramel Ribbon Crunch'";
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 'p1007'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "p1007"';
