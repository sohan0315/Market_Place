...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($conns,"SELECT * FROM hotel where Hotel_ID = 't1003'");
        ...
        $sql1 = "SELECT * from service_review where product = 'Bangalore'";
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 't1003'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "t1003"';
