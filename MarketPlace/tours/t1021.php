...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($conns,"SELECT * FROM hotel where Hotel_ID = 't1021'");
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 't1021'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "t1021"';
