...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($connd,"SELECT * FROM services where service_code = 's2'");
        ...
        $sql1 = "SELECT * from service_review where product = 'BATTERY REPLACEMENT'";
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 's2'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "s2"';
