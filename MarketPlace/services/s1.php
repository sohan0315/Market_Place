...
<div class="row">
    ...
    <?php
        ...
        $sql1 = "SELECT * from service_review where product = 'ANTIFREEZE ADDED'";
...
$result = mysqli_query($con,"SELECT * FROM most_visited_product where product_code = 's1'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "s1"';
