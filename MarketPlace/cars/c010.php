...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($con,"SELECT * FROM products where product_code = 'c010'");
        ...
        $sql1 = "SELECT * from service_review where product = 'Mini Cooper'";
...
$result = mysqli_query($conr,"SELECT * FROM most_visited_product where product_code = 'c010'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "c010"';
