...
<div class="row">
    ...
    <?php
        ...
        $result = mysqli_query($con,"SELECT * FROM products where product_code = 'c012'");
        ...
        $sql1 = "SELECT * from service_review where product = 'Honda Civic Type R'";
...
$result = mysqli_query($conr,"SELECT * FROM most_visited_product where product_code = 'c012'");
...
$sql = 'UPDATE most_visited_product SET visited_count ='.$visited_count_temp.' WHERE product_code = "c012"';
