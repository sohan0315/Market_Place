...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
      ...
      </br></br><div style="color:black; margin-left: 45%;"><h6>KOPI LUWAK</h6></div></br></br>
      ...
      <?php
            ...
            mysqli_close($conn);
        ?>
    </br></br><div style="color:black; margin-left: 45%;"><h6>AUTOCAR PRODUCTIONS</h6></div></br></br>
    <?php
        $url = 'https://tanayganeriwal.live/admin.php';
        $curl = curl_init();
        ...
        echo '<table id="customers" style="margin-left: 140px;">';
        echo '<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>User Name</th><th>Email Address</th><th>Home Phone</th></tr>';
        foreach($data as $row){
            echo '<tr>';
        ...
        echo '</br>';
    ?>
</br></br><div style="color:black; margin-left: 45%;"><h6>DDVV Tours and Travels</h6></div></br></br>
<?php
        $url = 'https://sohanshirodkar.live/secure_section.php';
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_URL, $url);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        $result = curl_exec($curl);
