...
setcookie('my_array['.$index.']', 'Product5.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product5.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product5.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Drinks / White Hot Chocolate<h4>
                  </br>
                  <h6>White Hot Chocolate</h6>
                  <p>A traditional hot chocolate beverage made with white chocolate sauce and steamed milk, topped with whipped cream.</p>
                </div>
              </div>
