...
setcookie('my_array['.$index.']', 'Product11.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    ...
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product11.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Frappuccino / Matcha Crème <h4>
                  </br>
                  <h6>Matcha Crème Frappuccino</h6>
                  <p>This blend of sweetened premium matcha green tea, milk and ice topped off with sweetened whipped cream—inspires a delicious boost and good green vibes.</p>
                </div>
              </div>
