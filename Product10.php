...
setcookie('my_array['.$index.']', 'Product10.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    ...
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product10.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Frappuccino / Mocha Cookie Crumble<h4>
                  </br>
                  <h6>Mocha Cookie Crumble</h6>
                  <p>Frappuccino Roast coffee, mocha sauce and Frappuccino chips blended with milk and ice, layered on top of whipped cream and chocolate cookie crumble and topped with vanilla whipped cream, mocha drizzle and even more chocolate cookie crumble. Each sip is as good as the last . . . all the way to the end.
                  </p>
                </div>
              </div>
