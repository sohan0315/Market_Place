...
setcookie('my_array['.$index.']', 'Product8.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product8.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product8.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Frappuccino / Caramel Ribbon Crunch<h4>
                  </br>
                  <h6>Caramel Ribbon Crunch</h6>
                  <p>Buttery caramel syrup blended with coffee, milk and ice, then topped with a layer of dark caramel sauce, whipped cream, caramel drizzle and a crunchy caramel-sugar topping—oh-so-beautifully delicious.</p>
                </div>
              </div>
