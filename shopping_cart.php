        ...
        <div class="card-deck">
          <div class="card p-2 border-secondary mb-2" >
            ...
            <div class="card-body p-1">
              <h4 class="text-center" style="font-weight: bold; color:black;" ><?= $row['product_name'] ?></h4>
              <h5 class="card-text text-center" style="font-weight: bold; color:black;" ><i class="fas fa-dollar-sign"></i>&nbsp;&nbsp;<?= number_format($row['product_price'],2) ?>/-</h5>
            ...
            <div class="card-footer p-1">
              <form action="" class="form-submit">
                ...
                <button class="btn btn-info btn-block addItemBtn" style="color:black; background: #4caf50;"><i class="fas fa-cart-plus" style="color:black"></i>&nbsp;&nbsp;Add to
                  cart</button>
              </form>
            </div>
          </div>
