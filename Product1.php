...
setcookie('my_array['.$index.']', 'Product1.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product1.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product1.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Coffees / Caffè Misto<h4>
                  </br>
                  <h6>Caffè Misto</h6>
...
<!-- <button id="fixedbuttonguest" type="button" class="btn btn-dark"><a style="color:#4caf50" href="login.php"><i class="fas fa-shopping-basket"></i> Buy Now</a></button> -->
<button id="fixedbutton" type="button" class="btn btn-dark"><a style="color:#4caf50" href="login.php"><i class="fas fa-shopping-basket"></i> Buy As Guest</a></button>
