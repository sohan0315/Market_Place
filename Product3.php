...
setcookie('my_array['.$index.']', 'Product3.php');
?>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="zoom" style="float:left">
                    <a href="Product3.php">
                    <img class="w-100" style="border-radius: 23px; width: 256px!important;" src="img\Product3.jpg" >
                    </a>
                </div>
                </div>
                <div class="col">
                  <h4 style="content:center">Menu / Hot Coffees / Cappuccino<h4>
                  </br>
                  <h6>Cappuccino</h6>
                  <p>Dark, rich espresso lies in wait under a smoothed and stretched layer of thick milk foam. An alchemy of barista artistry and craft.</p>
                </div>
              </div>
